...
module XRange =
    ...
    let delete (range : Range) (shift : ShiftDirection) =
        let shift' = shift.Box ()
    ...
    let insert (range : Range) (shift : ShiftDirection) copyOrigin =
        let shift' = shift.Box ()
    ...
    /// <param name="value">The value(s) to use.</param>
    ...
    module Row =
        ...
        let insert (range : Range) (shift : ShiftDirection) copyOrigin =
            let shift' = shift.Box ()
            let copyOrigin' = Utilities.boxOrMissing<obj> copyOrigin
            range.EntireRow.Insert(shift', copyOrigin') |> ignore
